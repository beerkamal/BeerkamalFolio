  ...
  setList() {
    this.list = [
      ...
      },
      {
        name: "Memory",
        imageSources: [
          "./models/projects/memory/slideA.jpeg",
          "./models/projects/memory/slideB.jpeg",
          "./models/projects/memory/slideC.jpeg",
          "./models/projects/memory/slideD.jpeg",
        ],
        floorTexture: this.resources.items.projectsMemoryFloorTexture,
        link: {
          href: "https://threejs-journey.com?c=p3",
          x: -4.8,
          y: -3,
