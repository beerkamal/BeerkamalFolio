...
export default class Floor {
  constructor(_options) {
    ...
    // Colors
    this.colors = {};
    this.colors.topLeft = "#aaffaa"; // Light green
    this.colors.topRight = "#55ff55"; // Medium green
    this.colors.bottomRight = "#228B22"; // Dark green
    this.colors.bottomLeft = "#339933"; // Medium-dark green
